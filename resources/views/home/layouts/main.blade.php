...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            min-height: 100%; /* Ensure the sidebar takes full height */
        }
        ...
        .content.closed {
            width: calc(100% - 64px); /* Adjust the width based on your sidebar width */
        }
...
<body>
    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="flex-1 content" id="main-content">
            @yield('content')
        </div>
    </div>
